...
const sections = [
   {
    ...
    title: `✃ INFO`,
	rows: [
	    {title: "💻INFO BOT", rowId: '.info', description: 'Info Fronbot' },
	    {title: "🗃️MENU", rowId: '.menu', description: 'Back to menu' },
	{title: "👤OWNER", rowId: '.owner', description: 'Pemilik Fronbot' },
	{title: "💰SEWA BOT", rowId: '.sewa', description: 'Sewa Fronbot' },
	]
    },
]
